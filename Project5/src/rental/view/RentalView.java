...
public int RentalMenu() {
	...
	public void viewAll(ArrayList<Rental> rList) {
		...
		System.out.println("=-=-=-=-==-=-=--=-=-");
		System.out.println("대여번호 : "+rental.getLeaseNo());
		System.out.println("도서번호 : "+rental.getBookNum());
		System.out.println("도서이름 : "+rental.getBookName());
	
		System.out.println("고객아이디 : "+rental.getUserId());
	
		System.out.println("대여일 : "+rental.getLeasDate());
